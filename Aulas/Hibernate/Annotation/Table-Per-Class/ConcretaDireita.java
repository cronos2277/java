...
@Entity
@Table(name="Direita_tabela_por_classe")
//Para herencas voce precisa dessa anotacao abaixo.
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
public class ConcretaDireita extends Abstrata{ //Deve ter heranca atraves do Extends
	public String direita;
	public ConcretaDireita() {
		super();
		this.direita = "estou a direita";
	}
